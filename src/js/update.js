...
function update(dt){
        ...
        if(e.hp<=0){
          ...
          if(e.type==='boss'){
            if(e._isFake){
              ...
              if(coresCollected>=coresNeeded&&!exitOpen){exitOpen=true;flash('EXIT ONLINE','#ff0');}
            }
          }
          // zombie drops bonus
          if(e.type==='zombie'){
  ...
  if(!monsterHouse&&!exitOpen&&coresCollected>=coresNeeded&&!_bossAlive){exitOpen=true;flash('EXIT ONLINE','#ff0');}}
