...
addEventListener('keydown',e=>{
  ...
  if(debug&&running){
    ...
    if(e.code==='KeyC'){const sk=['chase','victory','bomber','ghost','brute'];const cur=coffeeBreak?sk.indexOf(coffeeBreak.skit):-1;const nxt=sk[(cur+1)%sk.length];coffeeBreak={t:0,skit:nxt,_debug:true};_cbBtnPrev=false;PSG.jingle();flash('CB: '+nxt.toUpperCase(),'#0ff');return;} // C cycle coffee break
